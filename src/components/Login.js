...
const Login = () => {
  ...
  const LoginWallet = async () => {
    try {
      ...
      if(chainId === "0x3") {
        ...
        App.setSymbol("sEth");
        App.setPaypalContractAddress("0x280a80ECa2b2378f33A4f2D2758d58466c25df71")
  ...
  return (
    <div className='min-w-full h-4/5 flex justify-center flex-col items-center'>
      ...
      <div className='w-1/3 h-40 mt-4 bg-black bg-opacity-70 p-2 rounded-lg shadow-lg border-opacity-40 border-4 border-black flex flex-col justify-center items-center customColor'>
        <h1 className='text-white text-2xl font-medium text-center'>Login</h1>
        {ethereum != undefined ?
         <div onClick={LoginWallet} className='flex border-opacity-60 bg-opacity-90 text-lg font-medium border-2 cursor-pointer  bg-gradient-to-r from-rose-800 to-indigo-600 text-white mt-4 rounded-lg justify-center items-center py-1 px-2'>
          ...
          <div className='flex flex-col justify-center items-center'>
            ...
            <a target={"_blank"} href="https://chrome.google.com/webstore/detail/metamask/nkbihfbeogaeaoehlefnkodbefgpgknn">
              <div className='flex border-opacity-60 bg-opacity-90 text-lg font-medium border-2  cursor-pointer  bg-gradient-to-r from-rose-800 to-indigo-600 text-white mt-4 rounded-lg justify-center items-center py-1 px-2'>
               Install Metamask
               <img className='h-10' src='metamask.png' />
              </div>
            </a>
